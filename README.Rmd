...
sortedgermfree
#creating plot
plot((sortedgermfree$axis2~sortedgermfree$axis1), type="l", xlim = c(-.2,.6), ylim =c(-.4,0.4), ylab= "NMDS Axis 2", xlab="NMDS Axis 1" , par(mar=c(8,8,1,6)))
legend(0,0,c("Mouse 337","Mouse 343","Mouse 361","Mouse 387","Mouse 389"), lty=1, col=c("black","blue", "red","green","brown"))
points(sortedgermfree$day==, sortedgermfree$axis1==0.477973, col="black", pch=15)
points(sortedgermfree$mouse=="343", sortedgermfree$axis1==0.500614, col="blue", pch=15)
points(sortedgermfree$mouse=="337", sortedgermfree$axis1==0.477973, col="black", pch=15)
points(sortedgermfree$mouse=="337", sortedgermfree$axis1==0.477973, col="black", pch=15)
