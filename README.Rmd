...
germfree
#creating plot
plot(germfree$axis2~germfree$axis1, type="l", xlim = c(-.2,.6), ylim =c(min(germfree[ ,]), max(germfree[ ,-.6])), ylab= "NMDS Axis 2", xlab="NMDS Axis 1", lines(germfree$mouse, col=c("black", "blue","red","green","brown")))
```
