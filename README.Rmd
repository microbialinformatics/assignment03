...
#creating plot
plot(sortedgermfree[sortedgermfree$mouse.f=="337", "axis2"]~sortedgermfree[sortedgermfree$mouse.f=="337", "axis1"], type="l", col="black", xlim = c(-.2,.6), ylim =c(-.55,0.4), ylab= "NMDS Axis 2", xlab="NMDS Axis 1", asp=1.5, )
#adding mouse 343
...
#adding legend
location<-locator(1)
legend(location,c("Mouse 337","Mouse 343","Mouse 361","Mouse 387","Mouse 389"), lty=1, col=c("black","blue", "red","green","brown"), cex=.5)
