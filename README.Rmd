...
The result calculated using the formula is `r pcontinuous.formula` and the result of using the R function is also `r pcontinuous.dnorm`.
...
The calculated chi-squared value is `r F.nucleatum.chisq` before the Yates' continuity correction, after which it becomes `r F.nucleatum.chisq2`.
