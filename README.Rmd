...
matrix(c(5, 14, 19, 55,15, 70, 60, 29, 89), 3)
a<-5; b<-55; c<-14; d<-15; 
sq <- ((a*d-b*c)^2)
...
Ec <- (29*19)/89
Ed <- (29*70)/89
blarg <- (((5^2-Ea)/Ea)+((55^2-Eb)/Eb)+((14^2-Ec)/Ec)+((15^2-Ed)/Ed))

#Calculate the degrees of freedom: df = (ncol-1)*(nrow-1) -> no total columns/rows included
df <- (2-1)*(2-1)

```    
**Above I have manually calculated a X-square value of `r Xsq` with `r df` degree of freedom.**  
