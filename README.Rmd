...
```
The probability of x is equal to `r prob`. This value is exactly equal to the probability calculated in class, when we wanted to see if it was strange that one mice gave birth to 2 males and 8 females in one litter. 
...
```
The probability of x is equal to `r prob`.
