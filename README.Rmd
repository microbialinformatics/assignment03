...
The probability is `r pval.normal.formula` from the function I wrote, and `r pval.normal.builtin` for the built in formula.
...
I have not managed to get it matching. I keep getting `r chi.sq` rather than `r fnuc.chi1$p.value`.
