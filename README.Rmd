...
margin<-margin.table(peanut)

```
Answer: The candies are not evenly distributed amongst the colors. Graphic comparison of the poportions of each color in the bag with a uniform distribution of colors suggests that the distributions are uneven.  The binomial tests for each color against the uniform distribution are all significantly with p<.05. 