...
plot(a$axis1,a$axis2,type="l",col="black", xlab="NMDS Axis 1", ylab="NMDS Axis 2",ylim=c(-0.55,0.4),xlim=c(-0.3,0.7))
lines(b$axis1,b$axis2,type="l",col="blue")
lines(c$axis1,c$axis2,type="l",col="red")
lines(d$axis1,d$axis2,type="l",col="green")
lines(e$axis1,e$axis2,type="l",col="sienna")
legend(x=0.0,y=-0.2, c("Mouse 337","Mouse 343","Mouse 361","Mouse 387","Mouse 389"), lty=c(1,1), lwd=c(2.5,2.5),col=c("black","blue","red","green","sienna"),cex=0.5)
```
