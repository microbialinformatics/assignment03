...
Answer: using the formula the answer is `r fx`. According to the Z score table, the probability is between .02 and .03.
...
fract<-1/(sqrt(2*pi*3))
#second part
exfract<-(((10.3-5)^2)/(2*3^2))
fx<- fract*exp(-exfract)
fx
